...
<template>
    <header>
        ...
        <nav>
            ...
            <router-link v-if="!accountState.isLoggedIn" to="/login">登录｜注册</router-link>
            <Avatar id="avatar" @mouseenter="toggle" v-if="accountState.isLoggedIn"
                :label="accountState.username?.charAt(0).toUpperCase()" aria-haspopup="true"
